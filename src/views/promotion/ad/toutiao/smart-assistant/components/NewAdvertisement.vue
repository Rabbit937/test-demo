...
const form: ICreatePromotion = reactive({
	...
	text_abstract_list: [
		JSON.stringify({
			abstract_text: "这是一个测试文本摘要，很有必要测试一下，是的必须测试一下",
		}),
	],
	title_material_list: [
		{ title: "马上下载试玩" },
	...
	product_info: JSON.stringify({
		titles: ["忍界大战"],
		image_ids: ["web.business.image/202402205d0d74c09c1612244e8cbef1"],
		selling_points: ["近期热卖产品", "立即下载试玩"],
	}),
	web_url_material_list: [
		"https://www.chengzijianzhan.com/tetris/page/7374754531337437234",
	],
